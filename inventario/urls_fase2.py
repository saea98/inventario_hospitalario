...
urlpatterns = [
    ...
    path('propuestas/exportar-json-calidad/<uuid:propuesta_id>/', pedidos_views.exportar_propuesta_json_calidad, name='exportar_propuesta_json_calidad'),
    path('propuestas/importar-json/', pedidos_views.importar_propuesta_desde_json, name='importar_propuesta_json'),
