# Generated migration that cleans up existing tables and creates new ones
...
class Migration(migrations.Migration):
    ...
    operations = [
        # First, delete existing tables if they exist (using RunSQL for safety)
        migrations.RunSQL(
            sql="DROP TABLE IF EXISTS inventario_itemsolicitud CASCADE;",
            reverse_sql="",
            state_operations=[],
        ),
        migrations.RunSQL(
            sql="DROP TABLE IF EXISTS inventario_solicitudpedido CASCADE;",
            reverse_sql="",
            state_operations=[],
        ),
        
        # Now create the models fresh
